...
export const zhCN: Dict = {
  ...
  'qf.useSuggestion': '使用建议',
  'qf.tipPrototype': '可交互、可点击的界面原型——应用界面或可浏览的网页产品。',
  'qf.tipLiveArtifact': '独立可运行的网页或工具，打开即可直接使用。',
  'qf.tipSlideDeck': '演示文稿——以一连串幻灯片呈现的路演或演讲。',
  'qf.tipImage': '单张静态视觉——海报、插画、社交图片或封面。',
  'qf.tipVideo': '短小的动态作品——动画序列或片段。',
  'qf.tipHyperFrames': '多设备、多屏幕布局，在设备外框中并排展示。',
  'qf.tipAudio': '生成的音频——配音、旁白或声音。',
  'qf.tipOther': '其他——描述一下，我会转到合适的流程。',
