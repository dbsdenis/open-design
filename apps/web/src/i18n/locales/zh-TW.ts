...
export const zhTW: Dict = {
  ...
  'qf.useSuggestion': '使用建議',
  'qf.tipPrototype': '可互動、可點擊的介面原型——應用程式畫面或可瀏覽的網頁產品。',
  'qf.tipLiveArtifact': '獨立可執行的網頁或工具，開啟即可直接使用。',
  'qf.tipSlideDeck': '簡報——以一連串投影片呈現的提案或演講。',
  'qf.tipImage': '單張靜態視覺——海報、插畫、社群圖片或封面。',
  'qf.tipVideo': '短小的動態作品——動畫序列或片段。',
  'qf.tipHyperFrames': '多裝置、多螢幕版面，在裝置外框中並排呈現。',
  'qf.tipAudio': '生成的音訊——配音、旁白或聲音。',
  'qf.tipOther': '其他——描述一下，我會轉到合適的流程。',
