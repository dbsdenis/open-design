...
export const de: Dict = {
  ...
  'qf.useSuggestion': 'Vorschlag übernehmen',
  'qf.tipPrototype': 'Interaktives, klickbares UI-Mockup — App-Screens oder ein navigierbares Web-Produkt.',
  'qf.tipLiveArtifact': 'Eine eigenständige, lauffähige Webseite oder ein Tool, das du sofort öffnen und nutzen kannst.',
  'qf.tipSlideDeck': 'Eine Präsentation — Pitch oder Vortrag — als Folge von Folien.',
  'qf.tipImage': 'Ein einzelnes statisches Visual — Poster, Illustration, Social-Grafik oder Cover.',
  'qf.tipVideo': 'Ein kurzes Bewegtbild — animierte Sequenz oder Clip.',
  'qf.tipHyperFrames': 'Layouts für mehrere Geräte und Bildschirme, nebeneinander in Geräterahmen dargestellt.',
  'qf.tipAudio': 'Generiertes Audio — Voiceover, Erzählung oder Sound.',
  'qf.tipOther': 'Etwas anderes — beschreibe es und ich leite es in den passenden Ablauf.',
