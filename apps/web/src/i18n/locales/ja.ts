...
export const ja: Dict = {
  ...
  'qf.useSuggestion': '候補を使う',
  'qf.tipPrototype': '操作できるインタラクティブなUIモックアップ — アプリ画面やナビゲートできるWeb製品。',
  'qf.tipLiveArtifact': 'そのまま開いて使える、自己完結した動作するWebページやツール。',
  'qf.tipSlideDeck': 'プレゼン資料 — ピッチや講演をスライドの連続として。',
  'qf.tipImage': '単一の静止ビジュアル — ポスター、イラスト、SNS用画像、表紙など。',
  'qf.tipVideo': '短い動きのある作品 — アニメーションやクリップ。',
  'qf.tipHyperFrames': '複数デバイス・複数画面のレイアウトを、デバイスフレーム内に並べて表示。',
  'qf.tipAudio': '生成された音声 — ナレーション、ボイスオーバー、サウンド。',
  'qf.tipOther': 'その他 — 内容を教えてください。適切なワークフローに振り分けます。',
