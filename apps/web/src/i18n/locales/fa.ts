...
export const fa: Dict = {
  ...
  'qf.useSuggestion': 'استفاده از پیشنهاد',
  'qf.tipPrototype': 'نمونه‌ی اولیه‌ی رابط کاربری تعاملی و قابل کلیک — صفحه‌های اپ یا یک محصول وب قابل پیمایش.',
  'qf.tipLiveArtifact': 'یک صفحه یا ابزار وب مستقل و قابل اجرا که بلافاصله باز و استفاده می‌شود.',
  'qf.tipSlideDeck': 'یک ارائه — پیچ یا سخنرانی — به‌صورت دنباله‌ای از اسلایدها.',
  'qf.tipImage': 'یک تصویر ثابت — پوستر، تصویرسازی، گرافیک شبکه‌های اجتماعی یا جلد.',
  'qf.tipVideo': 'یک قطعه‌ی کوتاه متحرک — دنباله‌ی انیمیشنی یا کلیپ.',
  'qf.tipHyperFrames': 'چیدمان‌های چنددستگاهی و چندصفحه‌ای که کنار هم در قاب دستگاه‌ها نمایش داده می‌شوند.',
  'qf.tipAudio': 'صدای تولیدشده — صداگذاری، روایت یا صدا.',
  'qf.tipOther': 'چیز دیگری — توضیح دهید تا به مسیر درست هدایتش کنم.',
