...
export const ko: Dict = {
  ...
  'qf.useSuggestion': '제안 사용',
  'qf.tipPrototype': '클릭 가능한 인터랙티브 UI 목업 — 앱 화면이나 탐색 가능한 웹 제품.',
  'qf.tipLiveArtifact': '바로 열어 사용할 수 있는 독립 실행형 웹 페이지나 도구.',
  'qf.tipSlideDeck': '발표 자료 — 피치나 강연을 슬라이드 묶음으로.',
  'qf.tipImage': '단일 정적 비주얼 — 포스터, 일러스트, SNS 그래픽, 표지.',
  'qf.tipVideo': '짧은 모션 작품 — 애니메이션 시퀀스나 클립.',
  'qf.tipHyperFrames': '여러 기기·여러 화면 레이아웃을 디바이스 프레임 안에 나란히 표시.',
  'qf.tipAudio': '생성된 오디오 — 보이스오버, 내레이션, 사운드.',
  'qf.tipOther': '그 외 — 설명해 주시면 알맞은 워크플로로 연결합니다.',
