...
export const ru: Dict = {
  ...
  'qf.useSuggestion': 'Использовать подсказку',
  'qf.tipPrototype': 'Интерактивный кликабельный макет интерфейса — экраны приложения или веб-продукт для навигации.',
  'qf.tipLiveArtifact': 'Самодостаточная рабочая веб-страница или инструмент, который можно сразу открыть и использовать.',
  'qf.tipSlideDeck': 'Презентация — питч или доклад в виде последовательности слайдов.',
  'qf.tipImage': 'Одно статичное изображение — постер, иллюстрация, графика для соцсетей или обложка.',
  'qf.tipVideo': 'Короткий ролик с движением — анимация или клип.',
  'qf.tipHyperFrames': 'Макеты для нескольких устройств и экранов, показанные рядом в рамках устройств.',
  'qf.tipAudio': 'Сгенерированное аудио — озвучка, дикторский текст или звук.',
  'qf.tipOther': 'Что-то другое — опишите, и я направлю в нужный процесс.',
