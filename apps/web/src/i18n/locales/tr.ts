...
export const tr: Dict = {
  ...
  'qf.useSuggestion': 'Öneriyi kullan',
  'qf.tipPrototype': 'Etkileşimli, tıklanabilir arayüz modeli — uygulama ekranları veya gezilebilir bir web ürünü.',
  'qf.tipLiveArtifact': 'Hemen açıp kullanabileceğiniz, bağımsız ve çalışan bir web sayfası ya da aracı.',
  'qf.tipSlideDeck': 'Bir sunum — pitch ya da konuşma — slayt dizisi olarak.',
  'qf.tipImage': 'Tek bir durağan görsel — poster, illüstrasyon, sosyal medya görseli veya kapak.',
  'qf.tipVideo': 'Kısa bir hareketli parça — animasyon dizisi veya klip.',
  'qf.tipHyperFrames': 'Cihaz çerçeveleri içinde yan yana gösterilen çok cihazlı, çok ekranlı düzenler.',
  'qf.tipAudio': 'Üretilen ses — seslendirme, anlatım veya ses.',
  'qf.tipOther': 'Başka bir şey — anlatın, doğru akışa yönlendireyim.',
