...
export const id: Dict = {
  ...
  'qf.useSuggestion': 'Gunakan saran',
  'qf.tipPrototype': 'Mockup antarmuka interaktif yang bisa diklik — layar aplikasi atau produk web yang bisa dijelajahi.',
  'qf.tipLiveArtifact': 'Halaman atau alat web mandiri yang bisa langsung dibuka dan dipakai.',
  'qf.tipSlideDeck': 'Presentasi — pitch atau ceramah — sebagai rangkaian slide.',
  'qf.tipImage': 'Satu visual statis — poster, ilustrasi, grafik media sosial, atau sampul.',
  'qf.tipVideo': 'Karya gerak singkat — urutan animasi atau klip.',
  'qf.tipHyperFrames': 'Tata letak multi-perangkat dan multi-layar yang ditampilkan berdampingan dalam bingkai perangkat.',
  'qf.tipAudio': 'Audio yang dihasilkan — sulih suara, narasi, atau suara.',
  'qf.tipOther': 'Sesuatu yang lain — jelaskan dan saya arahkan ke alur yang tepat.',
