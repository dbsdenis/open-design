...
export const it: Dict = {
  ...
  'qf.useSuggestion': 'Usa suggerimento',
  'qf.tipPrototype': 'Mockup di interfaccia interattivo e cliccabile — schermate di app o un prodotto web navigabile.',
  'qf.tipLiveArtifact': 'Una pagina o uno strumento web autonomo e funzionante, da aprire e usare subito.',
  'qf.tipSlideDeck': 'Una presentazione — pitch o talk — come sequenza di diapositive.',
  'qf.tipImage': 'Un singolo elemento visivo statico — poster, illustrazione, grafica social o copertina.',
  'qf.tipVideo': 'Una breve clip in movimento — sequenza animata o video.',
  'qf.tipHyperFrames': 'Layout multi-dispositivo e multi-schermo mostrati affiancati dentro cornici di dispositivi.',
  'qf.tipAudio': 'Audio generato — voce fuori campo, narrazione o suono.',
  'qf.tipOther': 'Qualcos’altro — descrivilo e lo indirizzo al flusso giusto.',
