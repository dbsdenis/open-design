...
export const pl: Dict = {
  ...
  'qf.useSuggestion': 'Użyj sugestii',
  'qf.tipPrototype': 'Interaktywna, klikalna makieta interfejsu — ekrany aplikacji lub nawigowalny produkt webowy.',
  'qf.tipLiveArtifact': 'Samodzielna, działająca strona lub narzędzie web, które otworzysz i użyjesz od razu.',
  'qf.tipSlideDeck': 'Prezentacja — pitch lub wystąpienie jako sekwencja slajdów.',
  'qf.tipImage': 'Pojedyncza statyczna grafika — plakat, ilustracja, grafika do social media lub okładka.',
  'qf.tipVideo': 'Krótka ruchoma forma — animacja lub klip.',
  'qf.tipHyperFrames': 'Układy wieloekranowe i wieloplatformowe pokazane obok siebie w ramkach urządzeń.',
  'qf.tipAudio': 'Wygenerowane audio — lektor, narracja lub dźwięk.',
  'qf.tipOther': 'Coś innego — opisz, a skieruję to do właściwego procesu.',
