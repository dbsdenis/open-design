...
export const th: Dict = {
  ...
  'qf.useSuggestion': 'ใช้ตัวอย่าง',
  'qf.tipPrototype': 'ต้นแบบอินเทอร์เฟซแบบโต้ตอบที่คลิกได้ — หน้าจอแอปหรือเว็บผลิตภัณฑ์ที่นำทางได้',
  'qf.tipLiveArtifact': 'หน้าเว็บหรือเครื่องมือที่ทำงานได้ในตัว เปิดแล้วใช้งานได้ทันที',
  'qf.tipSlideDeck': 'งานนำเสนอ — พิตช์หรือการบรรยาย — เป็นชุดสไลด์',
  'qf.tipImage': 'ภาพนิ่งเดี่ยว — โปสเตอร์ ภาพประกอบ กราฟิกโซเชียล หรือปก',
  'qf.tipVideo': 'ชิ้นงานเคลื่อนไหวสั้น ๆ — ลำดับแอนิเมชันหรือคลิป',
  'qf.tipHyperFrames': 'เลย์เอาต์หลายอุปกรณ์หลายหน้าจอ แสดงเรียงข้างกันภายในกรอบอุปกรณ์',
  'qf.tipAudio': 'เสียงที่สร้างขึ้น — เสียงพากย์ การบรรยาย หรือเสียง',
  'qf.tipOther': 'อย่างอื่น — อธิบายมา แล้วฉันจะส่งไปยังเวิร์กโฟลว์ที่เหมาะสม',
