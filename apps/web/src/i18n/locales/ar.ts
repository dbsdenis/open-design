...
export const ar: Dict = {
  ...
  'qf.useSuggestion': 'استخدام الاقتراح',
  'qf.tipPrototype': 'نموذج واجهة تفاعلي قابل للنقر — شاشات تطبيق أو منتج ويب يمكن تصفّحه.',
  'qf.tipLiveArtifact': 'صفحة أو أداة ويب مستقلة وجاهزة للعمل، تفتحها وتستخدمها فورًا.',
  'qf.tipSlideDeck': 'عرض تقديمي — عرض أو محاضرة — كسلسلة من الشرائح.',
  'qf.tipImage': 'عنصر مرئي ثابت واحد — ملصق أو رسم توضيحي أو صورة لوسائل التواصل أو غلاف.',
  'qf.tipVideo': 'مقطع قصير متحرك — تسلسل متحرك أو لقطة.',
  'qf.tipHyperFrames': 'تخطيطات متعددة الأجهزة والشاشات معروضة جنبًا إلى جنب داخل إطارات الأجهزة.',
  'qf.tipAudio': 'صوت مُولَّد — تعليق صوتي أو سرد أو صوت.',
  'qf.tipOther': 'شيء آخر — صِفه وسأوجّهه إلى المسار المناسب.',
