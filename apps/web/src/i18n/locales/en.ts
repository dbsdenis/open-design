...
export const en: Dict = {
  ...
  'qf.useSuggestion': 'Use suggestion',
  'qf.tipPrototype': 'Interactive, clickable UI mockup — app screens or a web product you can navigate.',
  'qf.tipLiveArtifact': 'A self-contained, runnable web page or tool you can open and use right away.',
  'qf.tipSlideDeck': 'A presentation deck — a pitch or talk as a sequence of slides.',
  'qf.tipImage': 'A single static visual — poster, illustration, social graphic, or cover.',
  'qf.tipVideo': 'A short motion piece — an animated sequence or clip.',
  'qf.tipHyperFrames': 'Multi-device, multi-screen layouts shown side by side inside device frames.',
  'qf.tipAudio': 'Generated audio — voiceover, narration, or sound.',
  'qf.tipOther': 'Something else — describe it and I’ll route it to the right workflow.',
